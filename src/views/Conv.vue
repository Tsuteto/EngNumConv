...
<template>
  <main>
    ...
    <ul class="note">
      ...
      <li>そのほか<a href="https://github.com/Tsuteto/EngNumConv/README.md" target="_blank">詳細な説明はこちらへ</a></li>
    </ul>
    ...
    <div class="box box-conv">
      <div class="box-cont">
        <p>v1.0.0 - made by <a href="https://twitter.com/tsuteto">@tsuteto</a>, 2023.11.16<br />
